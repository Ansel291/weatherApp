function About() {
  return (
    <div className='max-w-2xl mx-auto conditions-text-color'>
      <h1 className='text-[26.5px] md:text-[30px] mb-[15px] md:mb-[18px] tracking-[.25px]'>
        Weather App
      </h1>
      <p className='mb-[20px] text-[17px] md:text-[19px] font-light leading-[23px] md:leading-[28px]'>
        ...
        zip code as well as displaying the 3-day forecast and 24-hour
        temperature forecast for the current day.
      </p>
